 ...
 * - Strips WeChat-specific section/div wrappers
 * - Removes inline styles (font-family, color, background, etc.)
 * - Extracts images from mmbiz.qpic.cn
 * - Converts WeChat section-based layout to semantic HTML
 */
...
export function extractWeChatImages(html: string): string[] {
  ...
  // Also check data-src (WeChat lazy-load)
